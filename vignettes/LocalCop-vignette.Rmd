...
library(tidyverse) # for data manupulations
...
To reduce the computatioanl time in model selection, we calculate the cross-validated likelihood for a subset of the sample. 
...
```{r cvplot, message=FALSE, fig.align='center', fig.width=8, fig.height=4, fig.cap="Cross-validated likelihood for copula and bandwidth selection based on a subset and full sample."}
